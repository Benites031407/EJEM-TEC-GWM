...
# Instancia o app
app = DjangoDash("SeguroApp", suppress_callback_exceptions=True)
...
nomes = ["qtd_reunioes", "qtd_seguros", "volume_pa"]
...
# Layout do app
app.layout = html.Div([
    html.H3("Comparativo Seguros", style={"textAlign": "center", "color": "black"}),
...
# Callback
@app.callback(
    Output("seguros-graph", "figure"),
    [
        Input("seguros-nome", "value"),
        Input("seguros-ano", "value"),
        Input("seguros-meses", "value")
    ]
)

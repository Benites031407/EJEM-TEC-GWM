...
# Instancia o app
app = DjangoDash("RendaVariavelApp", suppress_callback_exceptions=True)
...
nome_legenda = {
    ...
    "volume_ofertas": "Volume de Ofertas"
}
...
nomes = ["receita", "cpfs_operados", "volume_ofertas"]
...
# Layout do app
app.layout = html.Div([
    html.H3("Comparativo Renda Variável", style={"textAlign": "center", "color": "black"}),
...
@app.callback(
    Output("renda-graph", "figure"),
    [
        Input("renda-nome", "value"),
        Input("renda-ano", "value"),
        Input("renda-meses", "value")
    ]
)
